...
import eyesatop.ui_generic.viewmodels.functions.BatteryStateToColor;
...
public class PipeStatusModel {
    ...
    public PipeStatusModel(Activity activity, DroneController controller, ObservableValue<String> remoteIP,final int droneID) {
        ...
        batteryTextView = new TextViewModel((TextView) activity.findViewById(eyesatop.pipeapp2.R.id.lightBatteryTextView));
        aglTextView = new TextViewModel((TextView) activity.findViewById(eyesatop.pipeapp2.R.id.lightAGLTextView));
        atlTextView = new TextViewModel((TextView) activity.findViewById(eyesatop.pipeapp2.R.id.lightATLTextView));
        remoteIPTextView = new TextViewModel((TextView) activity.findViewById(eyesatop.pipeapp2.R.id.remoteIPTextView));
        droneIDTextView = new TextViewModel((TextView) activity.findViewById(eyesatop.pipeapp2.R.id.droneIDText));
        ...
        batteryTextView.textColor().bind(controller.droneBattery().transform(new BatteryStateToColor(activity)));

...
import eyesatop.controller.mock.tasks.gimbal.MockLockGimbalAtLocation;
import eyesatop.controller.tasks.TaskStatus;
import eyesatop.controller.tasks.exceptions.DroneTaskException;
import eyesatop.controller.tasks.gimbal.GimbalTaskType;
import eyesatop.util.geo.Location;

public class LockGimbalAtLocationTaskUpdate extends GimbalTaskUpdate {
    ...
    @JsonCreator
    public LockGimbalAtLocationTaskUpdate(@JsonProperty(UUID) java.util.UUID uuid,
    ...
    protected MockDroneTask<GimbalTaskType> createNewMockTask() {
        return new MockLockGimbalAtLocation(getUuid(),location);
    }
}

...
import eyesatop.controller.mock.tasks.camera.MockZoomIn;
import eyesatop.controller.tasks.TaskStatus;
import eyesatop.controller.tasks.camera.CameraTaskType;
import eyesatop.controller.tasks.exceptions.DroneTaskException;

public class ZoomInTaskUpdate extends CameraTaskUpdate{

    @JsonCreator
    public ZoomInTaskUpdate(@JsonProperty(UUID) java.util.UUID uuid,

...
import eyesatop.controller.mock.tasks.camera.MockStartRecording;
import eyesatop.controller.tasks.TaskStatus;
import eyesatop.controller.tasks.camera.CameraTaskType;
import eyesatop.controller.tasks.exceptions.DroneTaskException;

public class StartRecordingTaskUpdate extends CameraTaskUpdate {

    @JsonCreator
    public StartRecordingTaskUpdate(@JsonProperty(UUID) java.util.UUID uuid,
    ...
    protected MockDroneTask<CameraTaskType> createNewMockTask() {
        return new MockStartRecording(getUuid());
    }
}

...
import eyesatop.controller.mock.tasks.home.MockSetReturnHomeAltitude;
import eyesatop.controller.tasks.TaskStatus;
import eyesatop.controller.tasks.exceptions.DroneTaskException;
import eyesatop.controller.tasks.home.HomeTaskType;

public class SetReturnHomeAltitudeTaskUpdate extends HomeTaskUpdate {
    ...
    @JsonCreator
    public SetReturnHomeAltitudeTaskUpdate(@JsonProperty(UUID) java.util.UUID uuid,
    ...
    protected MockDroneTask<HomeTaskType> createNewMockTask() {
        return new MockSetReturnHomeAltitude(getUuid(),altitude);
    }
}

...
public class SetReturnHomeAltitudeRequest implements HomeTaskRequest {
    ...
    @JsonCreator
    public SetReturnHomeAltitudeRequest(@JsonProperty(ALTITUDE) double altitude) {
    ...
    public TaskResponse perform(DroneController controller) {
        ...
        try {
            DroneTask newTask = controller.droneHome().setReturnHomeAltitude(altitude);

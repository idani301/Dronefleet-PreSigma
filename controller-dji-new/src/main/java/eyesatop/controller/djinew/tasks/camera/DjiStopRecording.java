...
public class DjiStopRecording extends RunnableDroneTask<CameraTaskType> implements StopRecording {

    private final ControllerDjiNew droneController;
    private DJIError taskDjiError;

    public DjiStopRecording(ControllerDjiNew droneController) {
    ...
    protected void perform(Property<TaskProgressState> state) throws DroneTaskException, InterruptedException {
        ...
        Camera djiCamera = droneController.getHardwareManager().getDjiCamera();
        ...
        djiCamera.stopRecordVideo(new CommonCallbacks.CompletionCallback() {

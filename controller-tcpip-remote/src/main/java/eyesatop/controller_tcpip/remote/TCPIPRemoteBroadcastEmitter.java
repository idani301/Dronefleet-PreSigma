...
//
//
//public class TCPIPRemoteBroadcastEmitter {
//
...
//
//    private final Property<List<String>> knownIPS = new Property<>();
//    private final List<Integer> droneIDs;
//
//    private long lastKnownIPSentTime = 0;
//
//    public TCPIPRemoteBroadcastEmitter(List<Integer> droneIDs) {
...
//                                    socket.send(new DatagramPacket(payload, payload.length, interfaceAddress.getBroadcast(), REMOTE_BROADCAST_START_PORT));
//
...
//        Serialization.JSON.serialize(new RemoteBroadcastInfo(myIP, droneIDs),out);
//
//        return out.toByteArray();
//    }
//
//    public void setKnownIps(List<String> knownIps){
//        this.knownIPS.set(knownIps);
//    }
//}
